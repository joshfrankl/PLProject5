...
campus_buildings = {'ACA' : 'Academic Annex', 'ADH' : 'Almetris Duren Hall', 'AFP' : 'Athletic Fields Pavilion', 'AHG' : 'Anna Hiss Gymnasium', 'ANB' : 'Arno Nowotny Building', 'AND' : 'Andrews Dormitory', 'ARC' : 'Animal Resources Center', 'ART' : 'Art Building and Museum', 'ATT' : 'AT&T Executive Education and Conference Center',
                    ...
                    'RHD' : 'Roberts Hall Dormitory', 'RLM' : 'Robert Lee Moore Hall', 'RSC' : 'Recreational Sports Center',
                    'SAC' : 'Student Activity Center', 'SAG' : 'San Antonio Garage', 'SBS' : 'Red and Charline McCombs Field', 'SEA' : 'Sarah M. and Charles E. Seay Building', 'SER' : 'Service Building', 'SJG' : 'San Jacinto Garage', 'SRH' : 'Sid Richardson Hall', 'SSB' : 'Student Services Building', 'SSW' : 'School of Social Work Building', 'STD' : 'Darrell K Royal-Texas Memorial Stadium', 'SUT' : 'Sutton Hall', 'SWG' : 'Speedway Garage', 'SW7' : '2617 Speedway', 'SZB' : 'George I. Sanchez Building',
                    'TCC' : 'Joe C. Thompson Conference Center', 'TMM' : 'Texas Memorial Museum', 'TNH' : 'Townes Hall', 'TRG' : 'Trinity Garage', 'TSC' : 'Lee and Joe Jamail Texas Swimming Center', 'TSG' : '27th Street Garage', 'TTC' : 'Penick-Allison Tennis Center',
                    'UA9' : '2609 University Avenue', 'UIL' : 'Univeristy Interscholastic League', 'UNB' : 'Union Building', 'UPB' : 'University Police Building', 'UTA' : 'UT Administrative Building', 'UTC' : 'University Teaching Center', 'UTX' : 'Etter-Harbin Alumni Center',
                    'WAG' : 'Waggener Hall', 'WCH' : 'Will C. Hogg', 'WEL' : 'Robert A. Welch Hall', 'WIN' : 'F. Loren Winship Drama Building', 'WMB' : 'West Mall Office Building', 'WRW' : 'W. R. Woolrich Laboratories', 'WWH' : 'Walter Webb Hall'
}
# Tokens
